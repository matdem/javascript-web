// Chapitre 5 : Réagissez à des événements
...
// Une alternative avec une *fonction anonyme*
...
boutonElt.addEventListener("click", function(e) {
  console.log(`Événement : ${e.type}, texte de la cicle: ${e.target.textContent}`);
});
...
function infosSouris(e) {
  console.log(`Événement souris : ${e.type}, bouton ${getBoutonSouris(e.bouton)}, X : ${e.clientX}, Y : ${e.clientY}`);
}

// Gestion du clic souris
// document.addEventListener("click", infosSouris);

// Gestion de l'appui et du relâchement d'un vouton de la souris
